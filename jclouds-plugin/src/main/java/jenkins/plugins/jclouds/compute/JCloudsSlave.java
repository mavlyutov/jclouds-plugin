...
public class JCloudsSlave extends AbstractCloudSlave {
     ...
     * @param guestOS               - Type of guest operating system.
     * @throws IOException
    ...
    public enum GuestOS {
        ...
        public static final String CREATE_LAUNCH_SCRIPT_TEMPLATE = "echo 'cd C:\\start & java %s -jar slave.jar -jnlpUrl \"%s\"' >> " + JENKINS_SCRIPTS_LOCATION + "/agent-launcher.bat";
